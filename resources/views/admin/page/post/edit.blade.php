                        ...
                        <div class="body">
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('categories') ? 'focused error' : '' }}">
                                    ...
                                    <select name="categories[]" id="category" class="selectpicker" data-live-search="true" multiple>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('tags') ? 'focused error' : '' }}">
                                    ...
                                    <select name="tags[]" id="tag" class="selectpicker" data-live-search="true" multiple>
                                        @foreach($tags as $tag)
                                            <option
